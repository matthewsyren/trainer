 ...
 *
 * Description: Class fetches Quizzes the user has already completed and displays the user's results for those Quizzes
 */
    ...
    private class DataReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult ( int resultCode, Bundle resultData){
            ...
            if (resultCode == FirebaseService.ACTION_FETCH_STATISTIC_RESULT_CODE) {
                ...
                //Displays the Quizzes that the user has already taken and their results for those Quizzes
